...
function DonutChart({ segments }: { segments: { label: string; value: number; color: string }[] }) {
  ...
  const arcs = segments.map(seg => {
    ...
    const sA = angle; const eA = angle + frac * 360; angle = eA;
            ...
            <tbody>
              {filtered.map(v => (
                <tr key={v.id}>
                  ...
                  <td>
                    <span className="violation-pill" style={{
        ...
        <div className="report-left">
          <div className="report-meta-card">
            ...
            <p className="rmc-desc">
              A full analysis of PPE compliance across all monitored zones, including violation patterns,
              high-risk individuals, and actionable recommendations.
            </p>
